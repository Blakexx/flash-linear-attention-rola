...
from fla_rola.ops.common.chunk_delta_h import chunk_gated_delta_rule_fwd_kernel_h_blockdim64
from fla_rola.ops.cp.chunk_delta_h import pre_process_fwd_kernel_merged
from fla_rola.ops.utils.index import prepare_chunk_indices, prepare_chunk_offsets
from fla_rola.utils import get_multiprocessor_count
...
def intracard_merge(
    ...
    """
    from fla_rola.ops.cp.chunk_delta_h import merge_fwd_bwd_kernel
