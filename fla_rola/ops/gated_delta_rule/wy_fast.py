...
from fla_rola.utils import IS_NVIDIA_BLACKWELL, autotune_cache_kwargs, check_shared_mem
...
if IS_NVIDIA_BLACKWELL:
    ...
    See: https://github.com/fla_rola-org/flash-linear-attention/issues/638
