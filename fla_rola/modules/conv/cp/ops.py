...
from fla_rola.ops.cp import FLACPContext, conv_cp_send_recv_bwd, conv_cp_send_recv_fwd
...
class CausalConv1dFunctionCP(torch.autograd.Function):
    ...
    def forward(
        ...
        from fla_rola.modules.conv.triton.ops import causal_conv1d_fwd
    ...
    def backward(ctx, dy: torch.Tensor):
        # Import here to avoid circular dependency
        from fla_rola.modules.conv.triton.ops import causal_conv1d_bwd
