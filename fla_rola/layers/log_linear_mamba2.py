...
from fla_rola.layers.mamba2 import apply_mask_to_padding_states, causal_conv1d_fn, causal_conv1d_update, is_fast_path_available
from fla_rola.layers.utils import get_layer_cache, update_layer_cache
from fla_rola.modules.layernorm_gated import RMSNormGated, rmsnorm_fn
from fla_rola.ops.log_linear_attn.chunk import LogLinearAttentionState, chunk_log_linear_attn
...
class LogLinearMamba2(nn.Module):
    ...
    def __init__(
        ...
        if backend == 'cuda' and causal_conv1d_fn is None:
            ...
            backend = 'triton'
        if backend == 'triton':
            from fla_rola.modules.convolution import causal_conv1d as causal_conv1d_triton
            from fla_rola.modules.convolution import causal_conv1d_update as causal_conv1d_update_triton
