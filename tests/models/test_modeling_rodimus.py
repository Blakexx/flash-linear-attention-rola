...
from fla_rola.models import RodimusConfig
...
def test_modeling(
    ...
    run_test_model_forward_backward(L, B, T, H, D, RodimusConfig, use_l2warp=use_l2warp, dtype=dtype)
...
def test_generation(
    ...
    run_test_generation(L, B, T, H, D, RodimusConfig, dtype)
